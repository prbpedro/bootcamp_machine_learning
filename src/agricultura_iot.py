...
caminho_base='/home/prbpedro/Development/repositories/github/bootcamp_artificial_intelligence/src/input/agricultura_iot/'
caminho_treinamento=caminho_base+'BD_treinamento'  #dividido em 2 pastas (sadias e contaminadas) - 60/60
caminho_validacao=caminho_base+'BD_validacao' #dividido em 2 pastas (sadias e contaminadas) - 20/20
caminho_teste=caminho_base+'BD_teste' #dividido em 2 pastas (sadias e contaminadas) - 25/25
...
matriz_confusao=confusion_matrix(teste_labels,(previsao[:,0]).round())
